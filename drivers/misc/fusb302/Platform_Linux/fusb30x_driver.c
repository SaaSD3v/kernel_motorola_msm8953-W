...
static struct power_supply_desc usbc_psy_desc = {
	.name = "usbc",
	.type = POWER_SUPPLY_TYPE_TYPEC,
	.properties = fusb_power_supply_props,
	.num_properties = ARRAY_SIZE(fusb_power_supply_props),
	.get_property = fusb_power_supply_get_property,
	.set_property = fusb_power_supply_set_property,
	.property_is_writeable = fusb_power_supply_is_writeable,
};
			 ...
			 const struct i2c_device_id *id)
{
	...
	return ret;
unregister_usbcpsy:
	power_supply_unregister(usbc_psy_ptr);
	usbc_psy_ptr = NULL;
	return ret;
}
